# 📦 L2JBR Project - Instalação e Execução
...
| Componente   | Download |
|--------------|----------|
| 🔧 Patch Files (System, Animations, SysTextures) | [Download Patch](https://mega.nz/file/RqkwBI5a#Om9WSq19ZHxY-7zj2Y6Ly64HAvo5pYhtIrZv96fFvKM) |
| ☕ Java 21 | [Download Java 21](https://mega.nz/file/tnVX1axK#jn7AHj1TLG177cOFbIlgqOXo-mxYwwlLQGWwhbHIB6s) |
...
Antes de tudo, é necessário instalar o Java 21:
...
- O projeto requer Java 21 especificamente — versões superiores podem gerar incompatibilidades.
...
- Sistema operacional
- O que tentou fazer
Obrigado por usar o projeto Brproject!
